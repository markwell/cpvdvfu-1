...
<profile role="vol">
	...
	<tr>
	<td>Размер одежды:</td>
	<td><select name="Size" value="<?php echo $array['Size']?>"> <!-- <input name="Size" size="20" type="text" /> -->
	...
	<td><input maxlength="20" name="Password2" size="20" type="password" required /></td>
      ...
      <tr>
       <td></td>
      <td colspan="2"><input class="plain button red" type="submit" value="Сохранить" name="saveovolunteer" ></td>
      </tr>
     <br>
      </form>
      </table>
